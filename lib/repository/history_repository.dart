...
class HistoryRepository {
  ...
  Future<History?> loadHistory() async {
    ...
    final academics = academicRaw != null
        ...
        .map((e) => Academic.fromMap(e as Map<String, dynamic>))
        .toList()
        : <Academic>[];
    ...
    final works = workRaw != null
        ...
        .map((e) => Work.fromMap(e as Map<String, dynamic>))
        .toList()
        : <Work>[];
  ...
  Future<void> saveHistory(History history) async {
    ...
    final academicJsonString = jsonEncode(history.academics.map((e) => e.toMap()).toList());
    final qualificationJsonString = jsonEncode(history.qualifications.map((e) => e.toMap()).toList());
    final workJsonString = jsonEncode(history.works.map((e) => e.toMap()).toList());
